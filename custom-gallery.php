...
<div class="sidebar-widget child-nav">
    <div class="tab-post">
        <ul class="nav nav-pills nav-justified nav-all">
            ...
            <li class="nav-item">
            <a class=" nav-i " href="<?php echo esc_url(home_url('/news')); ?>">News</a>
            </li>
            <li class="nav-item"><a class=" nav-i " href="<?php echo esc_url(home_url('/past-events')); ?>">Past Events</a></li >
            <li class="nav-item"><a class=" nav-i  active-i" href="<?php echo esc_url(home_url('/gallery')); ?>">Gallery</a></li >
                        ...
                        <div class="event-item">
                            ...
                            <div class="event-content">
                                ...
                                <div class="event-text">
                                    ...
                                    <a class="btn btn-custom" href="#">Orphans</a>
                                </div>
